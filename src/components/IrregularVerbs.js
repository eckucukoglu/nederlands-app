...
const irregularVerbsData = [
  ...
  { inf: "scheren", imp: "schoor, schoren", perf: "geschoren", aux: "hebben", freq: false, en: "shave", tr: "tıraş olmak",
    ex: { pres: "Hij schoort zijn baard.", imp: "Hij schoor zich elke ochtend.", perf: "Hij heeft zich geschoren." } },
  { inf: "schieten", ip: "schoot, schoten", perf: "geschoten", aux: "hebben/zijn", freq: false, en: "shoot", tr: "ateş etmek, vurmak",
  ...
  { inf: "treffen", imp: "trof, troffen", perf: "getroffen", aux: "hebben", freq: false, en: "hit, meet", tr: "rastlamak, vurmak, etkilemek",
    ex: { pres: "Ik treff een goede vriend.", imp: "De storm trof de kust.", perf: "We hebben elkaar daar getroffen." } },
