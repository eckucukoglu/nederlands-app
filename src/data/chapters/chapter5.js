...
export const chapter5Dialogues = {
  "5.1": [
    { speaker: "Verteller", text: "Hans gaat boodschappen doen op de markt. Hij gaat naar Jasper, de groenteboer.", translation: { tr: "Hans pazarda alışveriş yapmaya gidiyor. Manav Jasper'a gidiyor.", en: "Hans goes shopping at the market. He goes to Jasper, the greengrocer." } },
    { speaker: "Jasper", text: "Wie is er aan de beurt?", translation: { tr: "Sıra kimde?", en: "Who's next?" } },
    { speaker: "Hans", text: "Ik.", translation: { tr: "Bende.", en: "Me." } },
    { speaker: "Jasper", text: "Zeg het maar.", translation: { tr: "Söyleyin bakalım (Dinliyorum).", en: "Go ahead and tell me. (I'm listening)." } },
    { speaker: "Hans", text: "Mag ik alsjeblieft een kleine courgette, twee gele paprika's en zes mooie tomaten?", translation: { tr: "Lütfen bir küçük kabak, iki sarı dolmalık biber ve altı güzel domates alabilir miyim?", en: "May I please have a small zucchini, two yellow bell peppers, and six beautiful tomatoes?" } },
    { speaker: "Jasper", text: "Hé! De tomaten zijn hier altijd mooi!", translation: { tr: "Hey! Burada domatesler her zaman güzeldir!", en: "Hey! The tomatoes are always beautiful here!" } },
    { speaker: "Hans", text: "Sorry. Tuurlijk!", translation: { tr: "Özür dilerim. Elbette!", en: "Sorry. Of course!" } },
    { speaker: "Jasper", text: "Anders nog iets?", translation: { tr: "Başka bir şey (istiyor musunuz)?", en: "Anything else?" } },
    { speaker: "Hans", text: "Ja, ik wil graag een typisch Nederlands gerecht maken. Onze buren komen morgen eten. Ze komen niet uit Nederland.", translation: { tr: "Evet, tipik bir Hollanda yemeği yapmak istiyorum. Komşularımız yarın yemeğe geliyor. Hollandalı değiller.", en: "Yes, I would like to make a typical Dutch dish. Our neighbors are coming for dinner tomorrow. They are not from the Netherlands." } },
    { speaker: "Jasper", text: "Buitenlanders vinden stamppot andijvie met spekjes vaak heerlijk. En ik heb vandaag mooie, goedkope andijvie.", translation: { tr: "Yabancılar genellikle pastırmalı hindiba püresini (stamppot andijvie) lezzetli bulurlar. Ve bugün elimde güzel, ucuz hindiba var.", en: "Foreigners often find endive stew with bacon delicious. And I have beautiful, cheap endive today." } },
    { speaker: "Hans", text: "Dat is een goed idee. Hoeveel heb ik nodig voor vier personen?", translation: { tr: "Bu iyi bir fikir. Dört kişi için ne kadara ihtiyacım var?", en: "That is a good idea. How much do I need for four people?" } },
    { speaker: "Jasper", text: "Ongeveer een halve kilo andijvie en een kilo aardappels. Voor de spekjes moet je naar de slager.", translation: { tr: "Yaklaşık yarım kilo hindiba ve bir kilo patates. Pastırma için kasaba gitmelisin.", en: "About half a kilo of endive and a kilo of potatoes. For the bacon, you have to go to the butcher." } },
    { speaker: "Hans", text: "Prima, doe maar.", translation: { tr: "Harika, verin/yapın o zaman.", en: "Great, go ahead." } },
    { speaker: "Jasper", text: "Dat was het?", translation: { tr: "Hepsi bu kadar mı(ydı)?", en: "Is that it?" } },
    { speaker: "Hans", text: "Nee. Doe ook maar een bloemkool. Een kleine bloemkool. En ook graag een klein bakje champignons. En peterselie. Dat kleine bosje graag.", translation: { tr: "Hayır. Bir de karnabahar verin. Küçük bir karnabahar. Ve lütfen küçük bir paket (kutu) mantar. Ve maydanoz. O küçük demeti lütfen.", en: "No. Please add a cauliflower too. A small cauliflower. And also a small box of mushrooms, please. And parsley. That small bunch, please." } },
    { speaker: "Jasper", text: "Verder nog iets? Ik heb mooie, fijne boontjes, verse knoflook, drie komkommers voor één euro ...", translation: { tr: "Başka bir şey var mı? Güzel, ince fasulyelerim, taze sarımsağım, bir euroya üç salatalığım var...", en: "Anything else? I have nice, fine beans, fresh garlic, three cucumbers for one euro..." } },
    { speaker: "Hans", text: "Nee, zo is het wel genoeg. Ik ga volgende week op vakantie.", translation: { tr: "Hayır, bu kadarı yeterli. Haftaya tatile gidiyorum.", en: "No, that's enough for now. I am going on vacation next week." } },
    { speaker: "Jasper", text: "O, lekker. Waarnaartoe?", translation: { tr: "Oh, ne güzel. Nereye?", en: "Oh, nice. Where to?" } },
    { speaker: "Hans", text: "Venetië.", translation: { tr: "Venedik'e.", en: "Venice." } },
    { speaker: "Jasper", text: "Prachtig. Dat is dan acht dertig. (...) Heb je er dertig cent bij?", translation: { tr: "Muhteşem. O zaman (tutar) sekiz otuz. (...) Üzerinde otuz sentin var mı?", en: "Beautiful. That will be eight thirty. (...) Do you have thirty cents with you?" } },
    { speaker: "Hans", text: "Nee, sorry.", translation: { tr: "Hayır, üzgünüm.", en: "No, sorry." } },
    { speaker: "Jasper", text: "Geeft niet. Acht vijftig, negen en dat is tien. Nou, prettige vakantie!", translation: { tr: "Önemli değil. Sekiz elli, dokuz ve on. Peki, iyi tatiller!", en: "Doesn't matter. Eight fifty, nine, and that makes ten. Well, have a nice vacation!" } },
    { speaker: "Hans", text: "Dank je wel. Prettig weekend. Dag!", translation: { tr: "Teşekkür ederim. İyi hafta sonları. İyi günler!", en: "Thank you. Have a nice weekend. Bye!" } }
  ]
};
...
export const chapter5Sections = [
  {
    ...
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #3b82f6', marginBottom: '20px' }}>
            <h3 style={{ margin: '0 0 10px 0', color: '#60a5fa' }}>🗣️ Dialogue: Op de markt (At the market)</h3>
            <p>Hans is buying vegetables from Jasper the greengrocer. Pay attention to the most common phrases used at the market:</p>
            <ul style={{ margin: '10px 0', paddingLeft: '20px', color: '#cbd5e1' }}>
              <li><strong>Wie is er aan de beurt?</strong> (Who's next?)</li>
              <li><strong>Zeg het maar / Doe maar.</strong> (Go ahead and tell me / Go ahead and do it).</li>
              <li><strong>Anders/Verder nog iets?</strong> (Anything else?)</li>
              <li><strong>Dat was het?</strong> (Is that all?)</li>
            </ul>
          </div>
        )}
      </>
    ...
    exerciseGroups: [
      {
        instruction: "Opdracht 1: Geef een reactie op de vragen (Okuduğunu Anlama / Reading Comprehension).",
        isExtra: false,
        questions: [
  ...
  },
  {
    ...
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #8b5cf6', marginBottom: '20px' }}>
            <h3 style={{ margin: '0 0 10px 0', color: '#a78bfa' }}>🥦 Groente en Fruit (Vegetables and Fruit)</h3>
            <div className="grid grid-cols-2 gap-4 text-sm text-slate-200">
              <div>
                <h4 className="font-bold text-purple-300 border-b border-purple-500/30 pb-1 mb-2">Groente (Vegetables)</h4>
                <ul className="space-y-1">
                  <li>de courgette (zucchini), de aubergine (eggplant)</li>
                  <li>de paprika (bell pepper), de tomaat (tomato)</li>
                  <li>de andijvie (endive), de aardappel (potato)</li>
                  <li>de bloemkool (cauliflower), de ui (onion)</li>
                  <li>de champignon (mushroom), de peterselie (parsley)</li>
                  <li>de knoflook (garlic), de komkommer (cucumber)</li>
                  <li>de wortel (carrot)</li>
                </ul>
              </div>
              <div>
                <h4 className="font-bold text-indigo-300 border-b border-indigo-500/30 pb-1 mb-2">Fruit (Fruit)</h4>
                <ul className="space-y-1">
                  <li>de aardbei (strawberry), de druif (grape)</li>
                  <li>de perzik (peach), de pruim (plum)</li>
                  <li>de kers (cherry), de appel (apple)</li>
                  <li>de peer (pear), de sinaasapppel (orange)</li>
                  <li>de mandarijn (mandarin), de kiwi (kiwi)</li>
                  <li>de banaan (banana)</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    exerciseGroups: [
      {
        instruction: "Opdracht 2: Anagrammen. Welke woorden (groente en fruit) vind je hier terug? (Anagrams. Which words can you find here?)",
        isExtra: false,
        questions: [
          { id: "5.3_opd2_1", type: "fill_in", question: "lapderaap (hint: pata... / pota...)", correctAnswer: "aardappel" },
          { id: "5.3_opd2_2", type: "fill_in", question: "ifrud (hint: üzüm / grape)", correctAnswer: "druif" },
          { id: "5.3_opd2_3", type: "fill_in", question: "kippara (hint: biber / pepper)", correctAnswer: "paprika" },
          { id: "5.3_opd2_4", type: "fill_in", question: "weltro (hint: havuç / carrot)", correctAnswer: "wortel" },
          { id: "5.3_opd2_5", type: "fill_in", question: "ommokmerk (hint: salatalık / cucumber)", correctAnswer: "komkommer" },
          { id: "5.3_opd2_6", type: "fill_in", question: "noklofok (hint: sarımsak / garlic)", correctAnswer: "knoflook" },
          { id: "5.3_opd2_7", type: "fill_in", question: "omatat (hint: domates / tomato)", correctAnswer: "tomaat" }
        ]
      },
      {
  ...
  },
  {
    id: "5.4",
    chapter: 5,
    title: "5.4 Pluralis (Çoğul Yapma Kuralları / Plural Rules)",
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #10b981', marginBottom: '20px' }}>
            <h3 style={{ margin: '0 0 10px 0', color: '#34d399' }}>📦 Pluralis (-en vs -s) (Plurals)</h3>
            <p className="text-sm text-slate-300">In Dutch, we usually add <strong>-en</strong> or <strong>-s</strong> to the end of a noun to make it plural. Let's look at the rules:</p>
            
            <h4 className="font-bold text-white mt-4">1. When to add '-s'?</h4>
            <ul className="text-sm text-slate-300 list-disc pl-5 mt-2 space-y-1">
              <li>Words ending in unstressed <strong>-el, -em, -en, -er</strong>: <em>tafels, bezems, jongens, kamers, buitenlanders.</em></li>
              <li>All diminutives ending in <strong>-je</strong>: <em>meisjes, boontjes, spekjes.</em></li>
              <li>Foreign loanwords (from English/French): <em>computers, cafés, champignons.</em></li>
            </ul>

            <h4 className="font-bold text-white mt-4">2. When to add -'s (Apostrophe)?</h4>
            <p className="text-sm text-slate-300 mt-2">For words ending in a long vowel (a, i, o, u, y), an apostrophe is used to protect the long vowel sound: <em>foto ➔ foto's, paprika ➔ paprika's, menu ➔ menu's.</em></p>

            <h4 className="font-bold text-white mt-4">3. Most other words take '-en':</h4>
            <p className="text-sm text-slate-300 mt-2"><em>de boodschap ➔ de boodschappen, de tomaat ➔ de tomaten.</em></p>
            
            <div className="bg-emerald-900/40 p-4 rounded-xl mt-5 border border-emerald-500/50">
              <h4 className="text-emerald-300 font-bold mb-1">⚠️ BIG EXCEPTION (UNITS OF MEASUREMENT)</h4>
              <p className="text-sm text-emerald-100">In Dutch, the words <strong>cent, jaar, uur, euro, kilo</strong> coming after a number NEVER TAKE PLURAL ENDINGS!</p>
              <p className="text-sm italic mt-2 text-white">"Ik heb twee uur les" (NOT twee uren!) <br/> "Dat is acht euro" (NOT acht euro's!) <br/> "Mag ik twee kilo andijvie?" (NOT twee kilo's!)</p>
            </div>
          </div>
        )}
      </>
    ...
    exerciseGroups: [
      {
        instruction: "Opdracht 3: Opschepper! (Gösteriş Yap! / Show off!). Maak het woord meervoud (plural).",
        isExtra: false,
        questions: [
      ...
      {
        instruction: "Slimme Oefeningen (Pedagogisch / Smart Exercises): Pluralis Uitzonderingen",
        isExtra: true,
        questions: [
          ...
          { id: "5.4_smart_2", type: "multiple_choice", question: "Waarom krijgt 'paprika' een apostrof-s (paprika's)?", options: ["Omdat het een Engels woord is.", "Om de lange 'a' klank (ses / sound) te behouden.", "Omdat het een klein woord is."], correctAnswer: "Om de lange 'a' klank (ses / sound) te behouden." }
        ]
      }
    ]
  },
  {
    id: "5.5",
    chapter: 5,
    title: "5.5 Adjectief (Sıfatların Çekimi / Adjectives)",
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #f43f5e', marginBottom: '20px' }}>
            <h3 style={{ margin: '0 0 10px 0', color: '#fb7185' }}>🎨 Adjectief (Adding -e to adjectives)</h3>
            <p className="text-sm text-slate-300 mb-3">In Dutch, when adjectives come <strong>before</strong> a noun, they usually get an <strong>-e</strong> at the end.</p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              <div className="bg-rose-900/20 p-3 rounded-lg border border-rose-500/30">
                <p className="text-xs text-rose-300 font-bold mb-1">DE-words (Always get -e!)</p>
                <ul className="text-sm text-slate-200">
                  <li>de groot ➔ de grot<strong>e</strong> komkommer</li>
                  <li>een groot ➔ een grot<strong>e</strong> komkommer</li>
                </ul>
              ...
              <div className="bg-amber-900/20 p-3 rounded-lg border border-amber-500/30">
                <p className="text-xs text-amber-300 font-bold mb-1">Plurals (Always get -e!)</p>
                <ul className="text-sm text-slate-200">
                  <li>grote komkommers</li>
                  <li>grote café's</li>
                </ul>
            ...
            <div className="bg-white/10 p-4 rounded-xl mt-4 border border-white/30">
              <h4 className="font-bold text-white mb-2">🚨 BIG EXCEPTION: When does it NOT get an '-e'?</h4>
              <p className="text-sm text-rose-200 font-medium">If the word is a <strong>"het-word"</strong> AND it is preceded by <strong>"een" (or no article)</strong>, the adjective does NOT get an '-e'!</p>
              <p className="text-sm text-slate-300 mt-2"><em>Het-words:</em> het huis (the house), het café (the café)</p>
              <ul className="text-sm text-white mt-1 list-disc pl-5">
                <li><strong>het</strong> groot huis ➔ het grot<strong>e</strong> huis (it gets -e because of 'het')</li>
                <li className="text-rose-300 font-bold"><strong>een</strong> groot huis (The Exception! When 'een' and a 'het-word' come together, no -e!)</li>
                <li className="text-rose-300 font-bold"><strong>een</strong> groot café</li>
              </ul>
            </div>
          </div>
    ...
    exerciseGroups: [
      {
        instruction: "Opdracht 4: Kies de goede vorm van het adjectief. (Choose the correct form of the adjective.)",
        isExtra: false,
        questions: [
          ...
          { id: "5.5_opd4_4", type: "multiple_choice", question: "4. Tot maandag! _________ weekend. (weekend = het-woord, geen artikel/no article)", options: ["Prettig", "Prettige"], correctAnswer: "Prettig" },
          ...
          { id: "5.5_opd4_9", type: "multiple_choice", question: "9. We hebben _________ tomaten. (meervoud / plural)", options: ["mooi", "mooie"], correctAnswer: "mooie" }
        ]
      },
      {
  ...
  },
  {
    ...
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <>
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #06b6d4', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#22d3ee' }}>🛒 Gesprek en Prijs (Conversation at the market & The price)</h3>
              <p className="text-sm text-slate-300">Common phrases heard when shopping at the market or supermarket:</p>
              <ul className="text-sm text-slate-200 mt-2 list-disc pl-5">
                <li><strong>Verder / Anders nog iets?</strong> (Anything else?) ➔ Nee, dat was het. (No, that's all.)</li>
                <li><strong>Tasje erbij?</strong> (Would you like a bag?) ➔ Ja, graag. / Nee hoor.</li>
                <li><strong>Gaat het zo mee?</strong> (Will you take it like this? / Without a bag?)</li>
              </ul>

              <h4 className="font-bold text-cyan-300 mt-4 border-b border-cyan-500/30 pb-1">💸 Prijzen vragen (Asking for prices)</h4>
              <ul className="text-sm text-slate-200 mt-2 list-disc pl-5">
                <li><strong>Wat kost</strong> de andijvie? ➔ Drie komkommers voor één euro.</li>
                <li><strong>Hoe duur zijn</strong> de boontjes? ➔ Dat is dan acht dertig. (€8.30)</li>
                <li><strong>Hebt u er dertig cent bij?</strong> (Do you have thirty cents to add to the payment?)</li>
              </ul>
            </div>
            
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #8b5cf6', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#a78bfa' }}>☝️ Imperatief (The Imperative)</h3>
              <p className="text-sm text-slate-300">In Dutch, the imperative is made using the verb stem. However, to avoid sounding rude, softening words like <strong>maar, even, eens</strong> are added to the sentence.</p>
              <p className="text-sm italic text-slate-200 mt-2">Neutral: Zeg het. (Say it.)<br/>Polite: Zeg het <strong>maar</strong>. (Go ahead and tell me.)<br/>Vertel <strong>eens</strong> over je familie. (Tell me a bit about your family.)</p>
            </div>
          </>
        )}
      </>
    ...
    exerciseGroups: [
      {
        instruction: "Opdracht 7: Maak het gesprek bij de groenteboer compleet. (Complete the conversation at the greengrocer.)",
        isExtra: false,
        questions: [
      ...
      },
      {
        ...
        isExtra: true,
        questions: [
          { id: "5.8_smart_1", type: "multiple_choice", question: "Hoe maak je een commando/imperatief vriendelijk (kibar / polite)?", options: ["Je gebruikt het hele werkwoord.", "Je gebruikt woorden zoals 'maar', 'even' of 'eens'.", "Je zegt altijd 'alstublieft' twee keer."], correctAnswer: "Je gebruikt woorden zoals 'maar', 'even' of 'eens'." },
          { id: "5.8_smart_2", type: "fill_in", question: "Vertaal de vraag: 'Ne kadar tutuyor? / Fiyatı ne kadar?' (How much does it cost?) -> Hoeveel ________ het?", correctAnswer: "kost" }
        ]
      }
    ]
  },
  {
    ...
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #6366f1', marginBottom: '20px' }}>
            <h3 style={{ margin: '0 0 10px 0', color: '#93c5fd' }}>📄 Text: Real Dutch winter food</h3>
            <p className="text-sm text-slate-300">We read the recipe for *Stamppot*, a classic Dutch winter dish.</p>
            <ul className="text-sm text-slate-200 mt-2 list-disc pl-5">
              <li><strong>Ingrediënten (Ingredients):</strong> Potatoes, endive, bacon, cherry tomatoes, diced cheese, milk, smoked sausage, butter, pepper, and salt.</li>
              <li><strong>Bereiding (Preparation):</strong> Peel the potatoes and boil them until done in 20 minutes. Clean the endive and cut the leaves. Fry the bacon. Mash the potatoes into a puree. Add the endive, bacon, cheese, and tomatoes.</li>
            </ul>
          </div>
        )}
      </>
    ...
    exerciseGroups: [
      {
        instruction: "Opdracht 12: Begrip van het recept (Tarif okuma anlama / Recipe reading comprehension).",
        isExtra: false,
        questions: [
    ...
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <>
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #f43f5e', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#fb7185' }}>🗣️ Uitspraak: u – uu (Pronunciation)</h3>
              <p className="text-sm text-slate-300"><strong>Opdracht 15 & 16:</strong> In Dutch, there is a huge difference between a short 'u' (ex: dus, cursus, lukken, zus) and a long 'uu' sound (ex: uur, buurman, minuut, natuur).</p>
            </div>

            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #3b82f6', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#60a5fa' }}>🇳🇱 Cultuur & In de praktijk: Eating in the Netherlands</h3>
              <p className="text-sm text-slate-300"><strong>De Eetcultuur (Eating Culture):</strong></p>
              <ul className="text-sm text-slate-200 mt-2 list-disc pl-5">
                <li>For lunch, Dutch people usually eat sandwiches (boterhammen) with cheese or cold cuts. The lunch break is typically only 30 minutes!</li>
                <li>Dinner (het avondeten) is usually eaten very early, around <strong>18:00 (zes uur)</strong>.</li>
                <li>When they like a meal, they look at the person next to them and wave their hand next to their face like a fan (Wapperen). This means <em>'heerlijk / lekker'</em> (delicious)!</li>
              </ul>
            </div>
          </>
        )}
  ...
  },
  {
    ...
    theory: (lang) => (
      <>
        {lang === 'tr' ? (
          ...
          <>
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #3b82f6', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#60a5fa' }}>🔄 Repetitie Les 4 (Review: Making an appointment)</h3>
              <p className="text-sm text-slate-300 mb-2">Phrases used to make an appointment and offer suggestions:</p>
              <ul className="text-sm text-slate-200 list-disc pl-5 space-y-1">
                <li><strong>Zullen we naar Parijs gaan?</strong> (Shall we go to Paris?)</li>
                <li><strong>Zullen we na de les koffie drinken?</strong> ➔ Ja, leuk!</li>
                <li><strong>Kun je vanavond?</strong> ➔ Nee, dan kan ik niet. (Can you tonight? No, I can't then.)</li>
            ...
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #8b5cf6', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#a78bfa' }}>🥦 Kernwoorden: Groente en Fruit (Keywords: Veg & Fruit)</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-2 gap-x-4 text-sm text-slate-200 bg-purple-900/20 p-4 rounded-xl border border-purple-500/30">
                <div><strong className="text-purple-300">de aardappel:</strong> potato</div>
                <div><strong className="text-purple-300">de tomaat:</strong> tomato</div>
                <div><strong className="text-purple-300">de komkommer:</strong> cucumber</div>
                ...
                <div><strong className="text-purple-300">de druif:</strong> grape</div>
                <div className="col-span-2 mt-2 pt-2 border-t border-purple-500/30">
                  <strong className="text-purple-300">een krop sla:</strong> a head of lettuce
                </div>
              </div>
            </div>
            ...
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #10b981', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#34d399' }}>📦 Meervoud (Plural in Dutch)</h3>
              <p className="text-sm text-slate-300 mb-2">In Dutch, we usually add <strong>-s</strong> or <strong>-en</strong> to the end of a noun to make it plural.</p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-bold text-emerald-300 text-sm mb-1">When to add only "-s"? (No Apostrophe)</h4>
                  <ul className="text-sm text-slate-200 list-disc pl-5 space-y-1">
                    <li>Unstressed final syllables ending in <strong>-el, -em, -en, -er</strong>:<br/><em>tafel ➔ tafels, bezem ➔ bezems, jongen ➔ jongens, kamer ➔ kamers</em></li>
                    <li>All diminutive words <strong>(-je)</strong>:<br/><em>meisje ➔ meisjes</em></li>
                    <li>Modern foreign loanwords:<br/><em>computer ➔ computers, café ➔ cafés</em></li>
                  </ul>
                </div>
                <div className="bg-emerald-900/30 p-3 rounded-lg border border-emerald-500/30">
                  <h4 className="font-bold text-emerald-300 text-sm mb-1">Uitzonderingen (Exceptions)</h4>
                  <p className="text-sm text-emerald-100 mb-1">Some words remain <strong>singular</strong> after numbers!</p>
                  <ul className="text-sm text-white list-disc pl-5 space-y-1">
                    <li>dertig <strong>cent</strong></li>
                    <li>acht <strong>euro</strong></li>
                    <li>twee <strong>kilo</strong> aardappels</li>
            ...
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #f59e0b', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#fbbf24' }}>🎨 Het Adjectief (Adjectives: the +e rule)</h3>
              <p className="text-sm text-slate-300 mb-2">An adjective describes a noun. When the adjective comes <strong>before</strong> the noun, we usually add <strong>-e</strong>. But there is an important exception!</p>
              
              <ul className="text-sm text-slate-200 list-disc pl-5 mb-3 space-y-1">
                <li><strong>Rule 1:</strong> If the adjective comes <em>after</em> the noun (with a verb like 'is' in between), do NOT add '-e'. <br/>➔ <em>Het eten is lekker.</em></li>
                <li><strong>Rule 2:</strong> For all <strong>'de'</strong> words, ALWAYS add '-e'.<br/>➔ <em>de grote komkommer, een grote komkommer</em></li>
                <li><strong>Rule 3 (EXCEPTION!):</strong> For <strong>'het'</strong> words, if preceded by <strong>'een'</strong> or <strong>no article at all</strong>, do NOT add '-e'!</li>
              </ul>

              <table className="w-full text-sm text-left text-slate-300 border-collapse mt-2">
                <thead>
                  <tr className="border-b border-slate-700 text-slate-200">
                    <th className="py-2">Article / Situation</th>
                    <th className="py-2">de-words (de komkommer)</th>
                    <th className="py-2 text-amber-300">het-words (het café)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-700/50">
                  <tr>
                    <td className="py-2 font-semibold">de or het</td>
                    <td className="py-2">de grot<strong>e</strong> komkommer</td>
                    <td className="py-2">het grot<strong>e</strong> café</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-rose-300">'een' or no article</td>
                    <td className="py-2">een grot<strong>e</strong> komkommer</td>
                    <td className="py-2 text-rose-300 font-bold">een groot café<br/>(groot café)</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold">plural (meervoud)</td>
                    <td className="py-2">de grot<strong>e</strong> komkommers</td>
                    <td className="py-2">de grot<strong>e</strong> cafés</td>
                  </tr>
                </tbody>
            ...
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.6)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #ef4444', marginBottom: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#f87171' }}>⚙️ Werkwoorden (Verbs) & Inversie</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <h4 className="font-bold text-rose-300 text-sm mb-2">Inversie (Inversion)</h4>
                  <p className="text-sm text-slate-300 mb-2">If we start the sentence with something else like a time word, the verb and subject swap places (Verb is always 2nd).</p>
                  <ul className="text-sm text-slate-200 list-disc pl-5">
                    <li><em>Wij hebben vanavond een feestje.</em></li>
                    <li>➔ <strong>Vanavond hebben wij</strong> een feestje.</li>
                    <li><em>Ik wil nu pizza.</em></li>
    ...
    exerciseGroups: [
      {
        instruction: "On-Class Oefening 1: Herhaling Les 4 (Zullen & Afspreken / Review: Making plans)",
        isExtra: false,
        questions: [
      ...
      {
        instruction: "On-Class Oefening 2: Groente en Fruit (Kernwoorden / Keywords)",
        isExtra: false,
        questions: [
      ...
      {
        instruction: "On-Class Oefening 4: Het Adjectief (+e of geen +e? / +e or no +e?)",
        isExtra: true,
        questions: [
          ...
          { id: "5_onclass_4_4", type: "fill_in", question: "Het eten ________ lekker. (Sıfat isimden sonra/Adjective after noun, no '+e').", correctAnswer: "is" },
          { id: "5_onclass_4_5", type: "fill_in", question: "De man is groot. ➔ Het is de ________ man.", correctAnswer: "grote" }
        ]
      },
      {
        instruction: "On-Class Oefening 5: Dialoog en Inversie (Dialogue and Inversion)",
        isExtra: true,
        questions: [
